...
<p>The game also needs <code>os</code> , <code>sys</code> , <code>random</code> and <code>pathlib</code> Which is all pre installed but pathlib was only introduced in Python 3.4 so you will need a more modern Python version/p>
